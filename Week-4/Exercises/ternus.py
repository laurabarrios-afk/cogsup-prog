...
posX1=[(-width/8)*3,-width/8,width/8] #Establishes positions for the first 3 circles and tags
posX2=[-width/8,width/8,(width/8)*3] #Changes the position of the first circle and tag
...
def run_trial(rad,use_tags,isi):
    ...
    load(circles1,circles2,tags1,tags2)
...
run_trial(rad=100, isi=30, use_tags=True)
